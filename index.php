...
<head>
    ...
    <title>WEB | DEVELOPERS | TEAM</title>
                                ...
                                <div class="main_home_slider text-center">
                                    <div class="single_home_slider">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                            ...
                                            <div class="home_btn">
                                                <a href="#contact" class="btn btn-lg m_t_10">GET
                                                    STARTED NOW</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-10 col-xs-10 margin-bottom-60">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10 col-sm-offset-1 col-xs-9 col-xs-offset-1">
                                                <article class="single_service_right_text">
                                                    <h4>STUDENT ASSIGMENTS DESIGN</h4>
                                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                        industry.
                                                        Lorem Ip sum has been the industry's standard dummy text ever.
                                                    </p>
                    ...
                    <div class="main_portfolio">
                        ...
                        <div class="work_menu text-center">
                            <div id="filters" class="toolbar mb2 mt2">
                                ...
                                <button class="btn-md fil-cat filter" data-rel="web" data-filter=".web">WEBSITE
                                    DESIGN</button>/
                                <button class="btn-md fil-cat filter" data-rel="design" data-filter=".design">STUDENT ASSIGMENTS
                                    DESIGN</button>
                            </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="single_team_img">
                                            <img src="assets/images/farai.jpg" alt="" />
                                        </div>
                                    ...
                                    <li>
                                        <div class="single_team_img">
                                            <img src="assets/images/tutu.jpg" alt="" />
                                        </div>
                                        <div class="single_team_text">
                                            <h4>Collins Matutu</h4>
                                            <p>Web Developer/Designer</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="single_team_img">
                                            <img src="assets/images/Mwape.jpeg" alt="" />
                                        </div>
                                        <div class="single_team_text">
                                            <h4>Mwape Yumba</h4>
                                            <p>Web Developer</p>
                                    ...
                                    <li>
                                        <div class="single_team_img">
                                            <img src="assets/images/thom.jpg" alt="" />
                                        </div>
                                        <div class="single_team_text">
                                            <h4>Thom Bertrum</h4>
                                            <p>Marketing</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="copyright_text">
                                        <p class=" wow fadeInRight" data-wow-duration="1s">2021. All Rights Reserved</p>
                                    </div>
                                </div>
                            </div>
                        </div>
